...
<form name="formadd" method="post" action="add_producto.php" enctype="multipart/form-data">
    <table border=0 CELLPADDING=10>
      ...
      <tr>
        <td width="200" height="50">Nombre: <input name="nombre" type="text" id="nombre" maxlength="255" size="40"
            required></td>
      ...
      <tr>
        <td colspan=2><TEXTAREA placeholder="Añade una descripción obligatoriamente" name="descripcion" id="descripcion"
            ROWS=5 COLS=40 required></TEXTAREA></td>
      </tr>
      <tr>
